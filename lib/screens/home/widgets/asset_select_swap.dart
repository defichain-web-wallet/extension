...
class AssetSelectSwap extends StatefulWidget {
  ...
  @override
  State<AssetSelectSwap> createState() => AssetSelectSwapState();
}

class AssetSelectSwapState extends State<AssetSelectSwap> {
  var tokenHelper = TokensHelper();
  GlobalKey _selectKey = GlobalKey();
  bool _isOpen = false;
  late OverlayState? _overlayState;
  OverlayEntry? _overlayEntry;
  static const _tileHeight = 69.0;
