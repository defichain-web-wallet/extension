...
import 'package:defi_wallet/screens/sell/sell_initiated_screen.dart';
...
class SellingScreen extends StatefulWidget {
  ...
  const SellingScreen({Key? key, this.isNewIban = false}) : super(key: key);
...
class _SellingScreenState extends State<SellingScreen> {
  ...
  _sendTransaction(context, tokensState, String token, AccountModel account,
    ...
    await Navigator.pushReplacement(
        context,
        PageRouteBuilder(
          pageBuilder: (context, animation1, animation2) => SellInitiatedScreen(
