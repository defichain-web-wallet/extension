...
class SelectPoolScreen extends StatefulWidget {
  final AssetPairModel assetPair;

  const SelectPoolScreen({Key? key, required this.assetPair}) : super(key: key);

  @override
  _SelectPoolScreenState createState() => _SelectPoolScreenState();
}

class _SelectPoolScreenState extends State<SelectPoolScreen> {
