...
import 'package:defi_wallet/screens/liquidity/liquidity_status_screen.dart';
...
class LiquidityConfirmationScreen extends StatefulWidget {
  ...
  const LiquidityConfirmationScreen({
    Key? key,
  ...
  @override
  State<LiquidityConfirmationScreen> createState() => _LiquidityConfirmationScreenState();
}

class _LiquidityConfirmationScreenState extends State<LiquidityConfirmationScreen> {
  ...
  submitLiquidityAction(state, tokensState, txState) async {
    ...
    try {
      ...
      if (widget.removeLT != 0) {
        ...
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => LiquidityStatusScreen(
              assetPair: widget.assetPair,
              isRemove: widget.removeLT != 0,
              amountA: widget.baseAmount,
              amountB: widget.quoteAmount,
