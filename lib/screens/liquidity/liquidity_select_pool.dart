...
class _LiquiditySelectPoolState extends State<LiquiditySelectPool>
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AmountField(
                          ...
                          available: lmState.status == LmStatusList.success
                              ? lmState.availableBalances![0]
                              : 0,
                          onAssetSelect: (asset) {},
                          onChanged: (value) {
                            // try {
  ...
  void _setBalances() {
    setState(() {
      balanceA =
          (convertFromSatoshi(balance) / widget.assetPair.percentages![2]) *
              widget.assetPair.percentages![0];
      balanceB =
          (convertFromSatoshi(balance) / widget.assetPair.percentages![2]) *
              widget.assetPair.percentages![1];
