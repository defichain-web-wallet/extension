...
class SecurePhraseScreenDragg extends StatefulWidget {
  final String? mnemonic;

  const SecurePhraseScreenDragg({
    Key? key,
    this.mnemonic,
  }) : super(key: key);

  @override
  State<SecurePhraseScreenDragg> createState() => _SecurePhraseScreenDraggState();
}

class _SecurePhraseScreenDraggState extends State<SecurePhraseScreenDragg> {
                        ...
                        Container(
                          child: ReorderableWrap(
                            ...
                            onReorder: (oldIndex, newIndex) {
                              setState(() {
                                String word = mnemonic.removeAt(oldIndex);
                                mnemonic.insert(newIndex, word);
                                generateList();
                              });
                            },
