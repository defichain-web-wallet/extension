...
class ECPair {
  ...
  String toWIF() {
    ...
    switch (network!.dialect) {
      case NetworkDialect.EVM:
        return '';
      default:
        final net = network as BtcNetworkType;
        return wif.encode(wif.WIF(version: net.wif, privateKey: privateKey!, compressed: compressed!));
    }
  }
