...
class DexHelper {
  ...
  Future<TestPoolSwapModel> calculateDex(
      String tokenFrom, String tokenTo, double? amountFrom, double? amountTo, String address, List<AddressModel> addressList, TokensState tokensState) async {
    List<double> rates = [];
    ...
    var dexModel = TestPoolSwapModel(tokenTo: tokenTo, tokenFrom: tokenFrom, priceFrom: rates[0], priceTo: rates[1]);
    if (amountFrom == null) {
